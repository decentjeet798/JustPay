              ...
              Expanded(
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      AuthEntryField(S.of(context).enter_amount,
                          TextEditingController(text: '\$ 926.21'), textStyle: Theme.of(context).textTheme.headline6!.copyWith(fontWeight: FontWeight.w700),),
                      SizedBox(
                        height: 20,
                      ),
                      AuthEntryField(S.of(context).enter_note,
                          TextEditingController(text: S.of(context).for_room_rent)),
                    ],
                  ),
                ),
              ),
